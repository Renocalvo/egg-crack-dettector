...
# Test pigpiod
sudo pigpiod
pigs help   # harus muncul daftar perintah

# Test kamera
python3 -c "from picamera2 import Picamera2; c=Picamera2(); print('Kamera OK:', c.sensor_name); c.close()"

# Test servo cepat (pin 14)
python3 -c "
import pigpio, time
pi = pigpio.pi()
pi.set_servo_pulsewidth(14, 1500)  # IDLE
time.sleep(1)
pi.set_servo_pulsewidth(14, 2500)  # 180°
time.sleep(1)
pi.set_servo_pulsewidth(14, 500)   # 0°
time.sleep(1)
pi.set_servo_pulsewidth(14, 0)     # off
pi.stop()
print('Servo OK')
"
```

### 1.6 Jalankan pigpiod otomatis saat boot (opsional)
