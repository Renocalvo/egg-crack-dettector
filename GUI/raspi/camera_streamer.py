    ...
    def run(self):
        try:
            ...
            cfg = self._picam2.create_video_configuration(
                ...
                controls={
                    ...
                    "ExposureValue":      0.0,    # +1 EV, coba 0.0 jika terlalu terang
                    "AwbEnable":          True,
                    "AwbMode":            0,      # 4 = indoor/fluorescent
                }
            )
        ...
        while self._running:
            try:
                ...
                # Langsung encode tanpa konversi ï¿½ picamera2 RGB888
                # sudah dalam urutan R,G,B yang benar untuk JPEG
                ok, buf = cv2.imencode(
                    '.jpg', frame_rgb,
